               ...
               <tbody>
                  ...
                  ?>
                     <tr>
                        ...
                        <td>
                           <a href="{{ route('admin.journal.images', $value->id) }}">
                        ...
                        <td>
                           <div class="btn-group">
                              <a href="{{ route('admin.journal.edit', $value->id) }}">
                                 <button class="btn btn-secondary btn-xs">
                                    <i class="fas fa-edit"></i>
                                 </button>
                              </a>
                              &nbsp;
                               <a href="{{ route('admin.journal.show', $value->id) }}">
                                 <button class="btn btn-primary btn-xs">
                                    <i class="fas fa-eye"></i>
                                 </button>
                              </a>
                              &nbsp;
                              <a href="{{ route('admin.journal.destroy', $value->id) }}" onclick="return confirm('Are you sure you want to delete this entry??')">
